...
namespace Sakila.Models
{
    public partial class sakilaContext : DbContext
    {
        ...
        public virtual DbSet<FilmText3> FilmText3 { get; set; }
        public virtual DbSet<Inventory> Inventory { get; set; }
        public virtual DbSet<Language> Language { get; set; }
        public virtual DbSet<NewStaffAudit> NewStaffAudit { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FilmText3>(entity =>
            {
                entity.HasKey(e => e.FilmId);

                entity.ToTable("film_text3");
            ...
            modelBuilder.Entity<NewStaffAudit>(entity =>
            {
                entity.HasKey(e => e.StaffAuditId);

                entity.ToTable("NewStaff_Audit");

                entity.Property(e => e.StaffAuditId).HasColumnName("Staff_Audit_Id");
