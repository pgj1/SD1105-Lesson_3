...
namespace Sakila.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var sakilaContext = _context.Customer.Include(c => c.Address).Include(c => c.Store);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,StoreId,FirstName,LastName,Email,AddressId,Active,CreateDate,LastUpdate")] Customer customer)
        {
